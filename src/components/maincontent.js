...
/* LED Data */
    ...
    const createLED = async () => {
        try {
            const response = await axios.post('http://localhost:3000/led/insert', {
                ...newLEDData,
                authKey: generateUniqueKey(),
            });
    ...
    const handleDeleteLED = async (ledId) => {
        try {
            await axios.post(`http://localhost:3000/led/delete/${ledId}`);
    ...
    const updateLED = async () => {
        try {
            const response = await axios.put(`http://localhost:3000/led/update/${updateLEDData._id}`, {
                ...updateLEDData,
                authKey: generateUniqueKey(),
            });
...
/* Ad Data */
    ...
    const createAdvertisement = async () => {
        try {
          const response = await axios.post('http://localhost:3000/ad/insert', newAdData);
    ...
    const handleDeleteAd = async (adId) => {
        try {
            await axios.post(`http://localhost:3000/ad/delete/${adId}`);
    ...
    const updateAdvertisement = async () => {
        try {
            const response = await axios.put(`http://localhost:3000/ad/update/${updateAdData._id}`, updateAdData);
...
/* Schedule Data */
    ...
    const createSchedule = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:3000/schedule/insert', scheduleDataWithTimestamps);
    ...
    const handleDeleteSchedule = async (scheduleId) => {
        try {
            await axios.post(`http://localhost:3000/schedule/delete/${scheduleId}`);
    ...
    const updateSchedule = async () => {
        try {
            const response = await axios.put(`http://localhost:3000/schedule/update/${updateScheduleData._id}`, updateScheduleData);
        ...
        const fetchData = async () => {
            try {
                const [ledsResponse, adsResponse, scheduleDataResponse] = await Promise.all([
                    axios.get('http://localhost:3000/led'),
                    axios.get('http://localhost:3000/ad'),
        ...
        <div className="main">
            {activeTab === 'led' && (
                <div className="container mt-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <h1 className="mb-0 text-primary">LED Screen</h1>
                        <button className="btn btn-primary" data-toggle="modal" data-target="#ledModel" onClick={() => setShowCreateModal(true)}>Create LED</button>    
                    </div>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-dark table-hover table-bordered">
                            <thead>
                            <tr>
                                <th class="text-white bg-primary">LED ID</th>
                                <th class="text-white bg-primary">LED Name</th>
                                <th class="text-white bg-primary">Location</th>
                        ...
                        {showCreateModal && (
                            <div class="modal fade" id="ledModel" tabindex="-1" role="dialog" aria-labelledby="createLED" aria-hidden="true">
                                <div class="modal-content bg-dark modal-dialog modal-dialog-centered">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-white" id="createLED">Create LED</h5>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onClick={createLED}>Create LED</button>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {showUpdateLEDModal && (
                            <div className="modal fade" id="updateLEDModel" tabIndex="-1" role="dialog" aria-labelledby="updateLED" aria-hidden="true">
                                <div className="modal-content bg-dark modal-dialog modal-dialog-centered">
                                <div className="modal-header">
                                    <h5 className="modal-title text-white" id="updateLED">Update LED</h5>
                                </div>
            ...
            {activeTab === 'ad' && (
                <div className="container mt-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <h1 className="mb-0 text-primary">Advertisement</h1>
                        <button className="btn btn-primary" data-toggle="modal" data-target="#adModel" onClick={() => setShowCreateModal(true)}>Create Ad</button>
                    ...
                    <div class="table-responsive mt-3">
                        <table class="table table-dark table-hover table-bordered">
                            <thead>
                            <tr>
                                <th class="text-white bg-primary">Ad Name</th>
                                <th class="text-white bg-primary">Content</th>
                                <th class="text-white bg-primary">Duration</th>
                                <th class="text-white bg-primary">Status</th>
                                <th class="text-white bg-primary">Action</th>
                            </tr>
                            </thead>
                        ...
                        {showCreateModal && (
                            <div class="modal fade" id="adModel" tabindex="-1" role="dialog" aria-labelledby="createAd" aria-hidden="true">
                                <div class="modal-content bg-dark modal-dialog modal-dialog-centered">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-white" id="createAd">Create Ad</h5>
                                    </div>
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onClick={createAdvertisement}>Create Ad</button>
                                    </div>
                                </div>
                            </div>
                        )}
                        ...
                        {showUpdateAdModal && (
                            <div className="modal fade" id="updateAdModel" tabIndex="-1" role="dialog" aria-labelledby="updateAd" aria-hidden="true">
                                <div className="modal-content bg-dark modal-dialog modal-dialog-centered">
                                    <div className="modal-header">
                                        <h5 className="modal-title text-white" id="updateAd">Update Ad</h5>
                                    </div>
                                    <div className="modal-body">
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary" onClick={updateAdvertisement}>Update Ad</button>
                                    </div>
                                </div>
                            </div>
                        )}
            ...
            {activeTab === 'schedule' && (
                <div className="container mt-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <h1 className="mb-0 text-primary">Schedules</h1>
                        <button className="btn btn-primary" data-toggle="modal" data-target="#scheduleModel" onClick={() => setShowCreateModal(true)}>Create Schedule</button>    
                    </div>
                    <hr className="horizontal-rule"></hr>
                    <div class="table-responsive mt-3">
                        <table class="table table-dark table-hover table-bordered">
                            ...
                            <tr>
                                <th class="text-white bg-primary">LED Name</th>
                                <th class="text-white bg-primary">Ad Name</th>
                                <th class="text-white bg-primary">Start Time</th>
                                <th class="text-white bg-primary">End TIme</th>
                                <th class="text-white bg-primary">Status</th>
                                <th class="text-white bg-primary">Action</th>
                                </tr>
                            </thead>
                        ...
                        {showCreateModal && (
                            <div class="modal fade" id="scheduleModel" tabindex="-1" role="dialog" aria-labelledby="createSchedule" aria-hidden="true">
                                <div class="modal-content bg-dark modal-dialog modal-dialog-centered">
                                    <div class="modal-header">
                                        <h5 class="modal-title text-white" id="createSchedule">Create Schedule</h5>
                                    </div>
                                    <div class="modal-body">
                        ...
                        {showUpdateScheduleModal && (
                            <div className="modal fade" id="updateScheduleModel" tabIndex="-1" role="dialog" aria-labelledby="updateSchedule" aria-hidden="true">
                                <div className="modal-content bg-dark modal-dialog modal-dialog-centered">
                                    <div className="modal-header">
                                        <h5 className="modal-title text-white" id="updateSchedule">Update Schedule</h5>
                                    </div>
                                    <div className="modal-body">
